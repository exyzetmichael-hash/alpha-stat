...
export const POLL_INTERVAL_MS = 1500; // как часто шлём heartbeat, пока панель открыта
export const IDLE_POLL_INTERVAL_MS = 8000; // heartbeat, пока панель свёрнута (только для счётчика онлайн)
